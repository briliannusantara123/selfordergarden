<?php $this->load->view('template/head') ?>
    ...
    height: 5px; /* Tinggi scrollbar */
      ...
      ::-webkit-scrollbar-thumb {
        background-color: #223c77; /* Warna thumb scrollbar */
      }
    ...
    #product_info{
        color: #223c77;margin-top: 2px;float: left;font-size: 12px;
    }
    #harga{
    ...
    #imgmodal{
        width: 300px;height: 240px; display: block;margin-left: auto;margin-right: auto;
    }
    #description{
        color: #223c77;float: left;font-size: 15px;
    }
...
.RAMEN_SET{
   background-image: url("<?= base_url() ?>/assets/icon/ramen.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.DONBURI{
   background-image: url("<?= base_url() ?>/assets/icon/donburi.png");
  background-repeat: no-repeat;
  background-size: 65%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.DONBURI_SET{
   background-image: url("<?= base_url() ?>/assets/icon/donburiset.png");
  background-repeat: no-repeat;
  background-size: 55%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.NIGHT_SET{
   background-image: url("<?= base_url() ?>/assets/icon/nightset.png");
  background-repeat: no-repeat;
  background-size: 63%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.KIDS_SET{
   background-image: url("<?= base_url() ?>/assets/icon/kidset.png");
  background-repeat: no-repeat;
  background-size: 69%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.TOPPING{
   background-image: url("<?= base_url() ?>/assets/icon/topping.png");
  background-repeat: no-repeat;
  background-size: 67%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.SIDE_DISH_APPETIZER{
   background-image: url("<?= base_url() ?>/assets/icon/appetizer.png");
  background-repeat: no-repeat;
  background-size: 43%;
  background-position-y: 20%;
  background-position-x: 50%;
...
<div class="wrapper" style="background-color: white;">
  ...
  <?php foreach($sube as $i){ ?>
      <div class="item">
      <a href="<?= base_url() ?>index.php/ordermakanan/menu/Makanan/<?= str_replace(" ","%20", $i['sub_category']) ?>#<?= str_replace(" ","_", $i['sub_category']) ?>" id="<?= str_replace(" ","_", $i['sub_category']) ?>" class="button <?= str_replace(" ","_", $i['sub_category']) ?> teste<?= str_replace(" ","_", $i['sub_category']) ?>"  style="text-decoration:none"><p style="margin-top: 60px;margin-bottom: 1px;"><?= str_replace(" ","", $i['sub_category'])?></p></a></div>
 <?php  }  ?>
 <?php foreach($sub as $i){ ?>
    <div class="item">
      <a href="<?= base_url() ?>index.php/ordermakanan/menu/Makanan/<?= str_replace(" ","%20", $i['sub_category']) ?>#<?= str_replace(" ","_", $i['sub_category']) ?>" id="<?= str_replace(" ","_", $i['sub_category']) ?>" class="button <?= str_replace(" ","_", $i['sub_category']) ?> test<?= str_replace(" ","_", $i['sub_category']) ?>"  style="text-decoration:none"><p style="margin-top: 60px;margin-bottom: 1px;"><?= str_replace(" ","", $i['sub_category'])?></p></a></div>
 <?php  }  ?>
</div>
...
<form action="<?= base_url() ?>index.php/ordermakanan/search/<?= $nomeja ?>" method="post" >
  <div class="container text-center" style="margin-top: 150px;display: flex;width:100%; position: fixed;z-index: 100000; ">
  <div class="row">
    <div class="col-9"><input type="text" name="keyword" class="form-control cari"  placeholder="Find Food..." style="border:1px solid #223c77;padding-left: 10px;padding-right: 20px;"></div>
    <div class="col-3"><button type="submit" class="btn" style="padding-left: 20px;padding-right: 20px;background-color:#223c77;color: white; ">Find</button></div>
  </div>
</div>
</form>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <?php foreach ($cekpesan as $c): ?>
                <h6 style="color: #223c77;font-size: 13px;">Ordered Qty : <?= $c->qty ?></h6>
              <?php endforeach ?>
              
              <!-- <?php $options = $this->Item_model->option($i->no); ?>
              <?php if ($i->with_option == 1 || $i->with_option == 2): ?>
                <a href="" style="text-decoration:none;" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $i->id ?>"><input type="text" name="pesan<?= $i->id ?>" id="pesan<?= $i->id ?>" class="form-control cari" placeholder="Customizable" style="border:1px solid #223c77;padding-left: 20%;" disabled></a>
              <?php else: ?>
                <input type="hidden" name="pesan<?= $i->id ?>" id="pesan<?= $i->id ?>" class="form-control cari" placeholder="Masukan Pesan" style="border:1px solid #223c77;">
              <?php endif ?> -->
            <input type="hidden" name="pesan<?= $i->id ?>" id="pesan<?= $i->id ?>" class="form-control cari" placeholder="Masukan Pesan" style="border:1px solid #223c77;">
            <input type="hidden" name="pesandua<?= $i->id ?>" id="pesandua<?= $i->id ?>" class="form-control cari" placeholder="Masukan Pesan" style="border:1px solid #223c77;">
            <input type="hidden" name="pesantiga<?= $i->id ?>" id="pesantiga<?= $i->id ?>" class="form-control cari" placeholder="Masukan Pesan" style="border:1px solid #223c77;">
             
              <div class="container text-center">
          <div class="row" style="margin-top: 5px;">
            <div class="col" >
              <button type="button" class="btn kurang<?= $i->id ?>" style="padding-left: 9px;padding-right: 9px;background-color:#223c77;color: white;" id="kurang<?= $i->id ?>" onclick="OrderQty('minus','<?= $i->id ?>','<?= $i->no ?>','<?= $i->stock ?>','<?= $i->need_stock ?>','<?= $this->session->userdata('user_order_id') ?>');"> - </button>
            </div>
            <div class="col">
                <!-- <?php if ($i->id_customer != $ic): ?>
                  <input type="text" name="qty<?= $i->id ?>" id="qty<?= $i->id ?>"  value="0"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:35px; " readonly>
                <?php  elseif ($i->id_customer == NULL): ?>
                  <input type="text" name="qty<?= $i->id ?>" id="qty<?= $i->id ?>"  value="NULL"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:35px; " readonly>
                <?php else: ?> 
                 <input type="text" name="qty<?= $i->id ?>" id="qty<?= $i->id ?>"  value="<?= $i->qty ?>"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:35px; " readonly>
                <?php endif ?> -->
                <input type="text" name="qty<?= $i->id ?>" id="jumlah<?= $i->id ?>" value="0"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:43px;text-align: center; " readonly>
            ...
            <div class="col">
              <?php $options = $this->Item_model->option($i->no); ?>
              <?php if ($i->with_option == 1 || $i->with_option == 2 || $i->with_option == 3): ?>
                <button type="button" class="btn nambah<?= $i->id ?>" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $i->id ?>" style="padding-left: 7px;padding-right: 7px;background-color:#223c77;color: white;">+</button>
              <?php else: ?>
                <button type="button" class="btn tambah<?= $i->id ?>" style="padding-left: 7px;padding-right: 7px;background-color:#223c77;color: white;" id="tambah<?= $i->id ?>" onclick="OrderQty('plus','<?= $i->id ?>','<?= $i->no ?>','<?= $i->stock ?>','<?= $i->need_stock ?>','<?= $this->session->userdata('user_order_id') ?>');">+</button>
              <?php endif ?>
              </div>
            </div>
          </div>
        ...
        <div class="container text-center sold" style="position:relative;">
          ...
          <a href="#"><img src="<?= $i->image_path ?>" alt="Red dot" style="width: 120px;height: 120px;border-radius: 20px;opacity: 075;" /><div class="soldtext">SOLD OUT</div></a>
              ...
              <?php  else: ?>
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $i->id ?>"><img src="<?= base_url();?>assets/logoDVLogin.png" alt="Red dot" style="width: 160px;height: 120px;border-radius: 20px;" /><div class="soldtext">SOLD OUT</div></a>
              <?php endif ?>
              <h6 style="color: #223c77;font-size: 16px;"class="text_<?= str_replace(" ","_", $i->description)?> text"><?= $i->description ?></h6>
          ...
          <div class="row" style="margin-top: 5px;">
            <div class="col" >
              <button type="button" class="btn" style="padding-left: 9px;padding-right: 9px;opacity:0.7;background-color:#223c77;color: white;"> - </button>
            </div>
            <div class="col">
                <!-- <?php if ($i->id_customer != $ic): ?>
                  <input type="text" name="qty<?= $i->id ?>" id="qty<?= $i->id ?>"  value="0"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:35px; " readonly>
                ...
                <?php else: ?> 
                 <input type="text" name="qty<?= $i->id ?>" id="qty<?= $i->id ?>"  value="<?= $i->qty ?>"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:35px; " readonly>
                <?php endif ?> -->
                <input type="text" value="0"  class="form-control" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:43px;text-align: center;opacity:0.7 " disabled>
            ...
            <div class="col">
              <?php $options = $this->Item_model->option($i->no); ?>
              <?php if ($i->with_option == 1 || $i->with_option == 2 || $i->with_option == 3): ?>
                <button type="button" class="btn" style="padding-left: 7px;padding-right: 7px;opacity:0.7;background-color:#223c77;color: white;">+</button>
              <?php else: ?>
                <button type="button" class="btn" style="padding-left: 7px;padding-right: 7px;opacity:0.7;background-color:#223c77;color: white;">+</button>
              <?php endif ?>
              </div>
...
<div class="container text-center">
  <!-- <div class="row">
    <div class="col-7" style="color: #223c77;">TakeAway?</div>
...
<div class="container text-center" id="tk<?= $i->id ?>" hidden >
  <div class="row">
    <div class="col" >
      ...
      <button type="button" class="btn mi<?= $i->id ?>" style="padding-left: 10px;padding-right: 10px;background-color:#223c77;color: white;"> - </button>
    </div>
    <div class="col">
      <input type="text" name="qta[]" id="qta" value="0"  class="form-control nu<?= $i->id ?>" id="cek<?= $i->id ?>" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:35px;" readonly disabled="disabled">
    </div>
    <div class="col">
      <button type="button" class="btn pl<?= $i->id ?>" id="pls<?= $i->id ?>" style="padding-left: 10px;padding-right: 10px;background-color:#223c77;color: white;">+</button>
    </div>
  </div>
</div>
...
<a href="<?php echo base_url() ?>index.php/Cart/home/<?= $nomeja ?>/Makanan/<?= $s ?>#<?= $s ?>" class="btn btn-outline-primary" style="padding-top: 20px;padding-bottom: 20px;padding-left: 40px;padding-right: 40px;">Cart<i class="fa fa-cart-plus"></i> <b id="total_qty" align="right"><?= $total_qty;?></b></a>
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php  else: ?>
          <img src="<?= base_url();?>assets/logoDVLogin.png" id="imgmodal" alt="Red dot" class="img-fluid" />
      <?php endif ?>
    <form action="#" method="post" id="input<?= $i->id ?>">
      ...
      <div class="card" style="margin-bottom: 10px;">
        <ul class="list-group list-group-flush">
          ...
          <?php if ($i->with_option == 1): ?>
            <select name="pesan<?= $i->id ?>" id="" class="form-control" style="text-align:center;color: #223c77;">
          ...
          <?php elseif($i->with_option == 2): ?>
            ...
            <select name="pesandua<?= $i->id ?>" id="" class="form-control" style="text-align:center;color: #223c77;">
              <option value="" selected disabled>Select Option Customize</option>
          ...
          <?php elseif($i->with_option == 3): ?>
            ...
            <div style="margin-top:5px;"></div>  
            <select name="pesantiga<?= $i->id ?>" id="" class="form-control" style="text-align:center;color: #223c77;">
              <option value="" selected disabled>Select Option Customize</option>
      ...
      <div class="row row-cols-auto">
        <?php if ($i->with_option == 1 || $i->with_option == 2 || $i->with_option == 3): ?>
        <div class="col"><button type="button" class="btn minus<?= $i->id ?>" style="padding-left: 15px;padding-right: 15px;background-color:#223c77;color: white;"> - </button></div>
        <div class="col"><input type="text" name="qty<?= $i->id ?>" id="qty<?= $i->id ?>"   class="form-control num<?= $i->id ?>" value="0" style="border:1px solid #223c77;margin-bottom: 5px;color: #223c77; width:43px;text-align: center; "  readonly></div>
        ...
        <div class="col"><button type="button" class="btn plus<?= $i->id ?>" style="padding-left: 15px;padding-right: 15px;background-color:#223c77;color: white;">+</button></div>
    ...
    <button id="simpan<?= $i->id ?>" type="button" class="btn" data-bs-dismiss="modal" aria-label="Close"  onclick="simpanalert('<?= $i->need_stock ?>')" style="background-color:#223c77;color: white;">Add to Cart <a id="total<?= $i->id ?>"></a></button>
    <?php endif ?>
      </div>
...
<script type="text/javascript">
  ...
  var all = document.getElementById('all');
  var rekomendasi = document.getElementById('rekomendasi');
  var item<?= str_replace(" ","_", $i['sub_category']) ?> = document.querySelector('.teste<?= str_replace(" ","_", $i['sub_category']) ?>');
  var itemall = document.querySelector('.testall');
  var itemrekomendasi = document.querySelector('.testrekomendasi');
