...
#reader {
  ...
  <div id="formContent">
    ...
    <div class="fadeIn first">
      ...
      <h1>Self Order Admin</h1>
    </div>

    <!-- Login Form -->
    <form action="<?= base_url() ?>index.php/Login/loginadmin" method="post">
      <input type="text" id="login" class="fadeIn second" name="username" placeholder="Enter Username" required="">
      <input type="password" id="login" class="fadeIn second" name="password" placeholder="Enter Password" required="">
