...
.wrapper .item{
 ...
 @media (max-width: 414px) {
    ...
    #imgmodal{
        width: 300px;height: 240px; display: block;margin-left: auto;margin-right: auto;margin-bottom: 20px;
    }
    #description{
        color: #223c77;float: left;font-size: 15px;
    }
...
.MILK_BASE{
   background-image: url("<?= base_url() ?>/assets/icon/milk_base.png");
  background-repeat: no-repeat;
  background-size: 68%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.ICE_BLENDED{
   background-image: url("<?= base_url() ?>/assets/icon/ice_blanded.png");
  background-repeat: no-repeat;
  background-size: 63%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.DRINKS{
   background-image: url("<?= base_url() ?>/assets/icon/juice.png");
  background-repeat: no-repeat;
  background-size: 75%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.CHOCOLATE{
   background-image: url("<?= base_url() ?>/assets/icon/chocolate.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.SMOOTHIES{
   background-image: url("<?= base_url() ?>/assets/icon/smoothies.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.COFFEE_MOCKTAIL{
   background-image: url("<?= base_url() ?>/assets/icon/coffee_moctail.png");
  background-repeat: no-repeat;
  background-size: 50%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.ARTISAN_TEA{
   background-image: url("<?= base_url() ?>/assets/icon/artisantea.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.SELECTION_TEA{
   background-image: url("<?= base_url() ?>/assets/icon/selectiontea.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.MILKSHAKE{
   background-image: url("<?= base_url() ?>/assets/icon/milkshake.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
.REFRESHING{
   background-image: url("<?= base_url() ?>/assets/icon/refreshing.png");
  background-repeat: no-repeat;
  background-size: 60%;
  background-position-y: 20%;
  background-position-x: 50%;
...
<div class="wrapper" style="background-color: white;">
 ...
 <?php foreach($sub as $i){ ?>
    <div class="item">
      <a href="<?= base_url() ?>index.php/orderminuman/menu/Minuman/<?= str_replace(" ","%20", $i['sub_category']) ?>#<?= str_replace(" ","_", $i['sub_category']) ?>" id="<?= str_replace(" ","_", $i['sub_category']) ?>" class="button <?= str_replace(" ","_", $i['sub_category']) ?> test<?= str_replace(" ","_", $i['sub_category']) ?>"  style="text-decoration:none;padding-top: 23px;"><p style="margin-top: 60px;margin-bottom: 1px;"><?= str_replace(" ","", $i['sub_category'])?></p></a></div>
 <?php  }  ?>
</div>
...
<div class="container text-center">
  <div class="row">
    <div class="col">
      <a href="<?= base_url() ?>ordermakanan/menu/Makanan/<?= $i['sub_category'] ?>/<?= $nomeja ?>" class="button <?= str_replace(" ","_", $i['sub_category']) ?>"><?= str_replace(" ","_", $i['sub_category'])?></a>
...
<form action="<?= base_url() ?>index.php/orderminuman/search/<?= $nomeja ?>" method="post" >
  <div class="container text-center" style="margin-top: 150px;display: flex;width:100%; position: fixed;z-index: 100000;">
  <div class="row">
    <div class="col-10"><input type="text" name="keyword" class="form-control cari"  placeholder="Find Drinks..." style="border:1px solid #223c77;"></div>
    <div class="col-2"><button type="submit" class="btn" style="background-color: #223c77;color: white;">Find</button></div>
  </div>
</div>
</form>
...
<a href="<?php echo base_url() ?>index.php/Cart/home/<?= $nomeja ?>/Minuman/<?= $s ?>#<?= $s ?>" class="btn btn-outline-success" style="padding-top: 20px;padding-bottom: 20px;padding-left: 40px;padding-right: 40px;">Cart<i class="fa fa-cart-plus"></i> <b id="total_qty" align="right"><?= $total_qty;?></b></a>
...
<script type="text/javascript">
  ...
  var itemrekomendasi = document.querySelector('.testrekomendasi');
    ...
    if (window.location.toString() == "<?= base_url() ?>index.php/orderminuman/menu/Minuman/<?= str_replace(" ","%20", $i['sub_category']) ?>#<?= str_replace(" ","_", $i['sub_category']) ?>") {
